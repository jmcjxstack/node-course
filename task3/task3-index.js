//To run task 3 please use the branch called task-3,
//otherwise just copy this code into index.js
//and comment the code present in index.js in this branch
const EventEmitter = require("./task3/EventEmitter.js");
const WithTime = require("./task3/WithTime.js");
const csvToJson = require("./task3/csvToJson.js");
